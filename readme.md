...
### Notes
I configured the project to integrate Appium tests with AWS Device Farm. See in pom.xml. You can also see Docs in https://docs.aws.amazon.com/devicefarm/latest/developerguide/test-types-appium-integrate.html
